...
void OrthoCameraController::OnEvent(Event& e)
{
    ...
    dispatcher.Dispatch<MouseScrolledEvent>(MT_BIND_EVENT_FN(OrthoCameraController::OnMouseScrolled));
    dispatcher.Dispatch<WindowResizeEvent>(MT_BIND_EVENT_FN(OrthoCameraController::OnWindowResized));
}
