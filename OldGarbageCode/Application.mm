...
void Application::Render() {
    ...
    Renderer2D::DrawRotatedQuad({0.0f, 0.5f, 1.0f}, {1.0f, 1.0f}, rotate_ * 15.0f, texture2, 1.0f, {1.0f, 1.0f, 1.0f, 1.0f});
    Renderer2D::EndScene();
    ...
    framebuffer->Bind();
    framebuffer->SetClearColor({1.0f, 1.0f, 0.0f, 1.0f});
...
//    RenderCommand::AddCommandEncoder(framebuffer->GetEncoder());
//    Renderer2D::BeginScene(projectionview);
//    Renderer2D::DrawRotatedQuad({0.0f, 0.0f, 1.0f}, {1.0f, 1.0f}, rotate_ * 25.0f, texture, 10.0f, {1.0f, 1.0f, 1.0f, 1.0f});
